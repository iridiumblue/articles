...
<img src="https://raw.githubusercontent.com/iridiumblue/about/master/pretty.png">
...
<img src="https://raw.githubusercontent.com/iridiumblue/about/master/roc.png">
...
<ul>
<li>|<strong>too_close_pairs</strong>| = δ |<strong>wrong_ordered_pairs</strong>|</li>
</ul>
<p>We fix this δ throughout training and update Γ to conform to it.  For given δ, we find Γ such that</p>
<ul>
<li>|<strong>pairs</strong> where y+Γ&gt;x| = δ |<strong>pairs</strong> where y&gt;x|</li>
</ul>
...
<p>Suppose we are calculating the loss function for a given white data point, <em>x</em>.  To calculate (3), we need to compare <em>x</em> against the entire training set of black predictions, <em>y</em>.<br>
